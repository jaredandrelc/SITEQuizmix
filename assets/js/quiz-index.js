const QUIZ_INDEX = [
    { url: 'data/quiz_ccna2_mod1.txt', syscat: 'Cisco Topic Quiz' },
    { url: 'data/quiz_ccna2_mod2.txt', syscat: 'Cisco Topic Quiz' },
    { url: 'data/quiz_ccna2_mod3.txt', syscat: 'Cisco Topic Quiz' },
